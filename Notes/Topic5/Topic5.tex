...
\begin{itemize}
    ...
    \begin{figure}[h!]
        ...
        \chemright{]^{6+}}
        \caption{The tris(tetraammine-$\mu$-dihydroxocobalt)cobalt($6+$) ion, \ce{[Co(Co(NH3)4(OH)2)3]^6+}}
    ...
    \begin{itemize}
        \item "Because $S_1\equiv\sigma$ and $S_2\equiv i$, locating a mirror plane or inversion center in a structure indicates that it is not chiral. A structure may be achiral by virtue of an $S_n$ axis where $n>2$ even without the presence of a mirror plane or inversion center as symmetry elements" \parencite[323]{bib:MiesslerFischerTarr}.
    ...
    \end{itemize}
    \item When describing molecular geometries, we assume that the metal $d$ electrons are stereochemically inactive.
