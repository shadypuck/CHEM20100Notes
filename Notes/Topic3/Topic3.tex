...
\begin{itemize}
    ...
    \item Characterization of selected homonuclerar diatomic molecules:
    \begin{itemize}
        \item \ce{He2}'s bond order is 0, with two bonding and two antibonding electrons. Thus, it has no significant tendency to form (it's bone energy is $\SI[per-mode=symbol]{0.01}{\joule\per\mole}$, compared to \ce{H2}'s $\SI[per-mode=symbol]{436}{\kilo\joule\per\mole}$).
    ...
    \item Comparing the PES spectrums for \ce{N2} and \ce{O2}, it can be seen that the \ce{N2} energy levels are closer together than the \ce{O2} ones.
    ...
    \item \textbf{Frontier orbitals}: The HOMO and LUMO, so-nambed because they lie at thee occupied-unocupied frontier.
    ...
    \begin{itemize}
        ...
        \item Additionally, the Lewis approach predicts two, 2-electron bonds, resulting in 4 electrons arount the central \ce{H} atom. However, the MO model suggests 2 electrons (in a $\sigma$ bond [$a_g$]) decentralized over all three atoms.
    \end{itemize}
