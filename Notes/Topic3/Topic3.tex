...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Roothaan retired, found retirememt boring, moved to Palo Alto and was key in the development of computer processors.
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Reduce to irreeducible representations.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}[
                ...
                \draw [ultra thick,gry]
                    (2,-18.65) -- node{\Large$\upharpoonleft$\hspace{-1mm}$\downharpoonright$} node[below=2mm]{$p_z(A_1)$} ++(0.5,0)
                    ++(0.1,0) -- node{\Large$\upharpoonleft$} node[below=7mm]{$p_y(B_2)$} ++(0.5,0)
                    ++(0.1,0) -- node{\Large$\upharpoonleft$} node[below=2mm]{$p_x(B_1)$} ++(0.5,0)
                ;
                \draw [ultra thick,gry]
        ...
        \end{figure}
        \item We can now compare this with the results from photoelectron spectroscopy and see that our predictions are correct. \begin{figure}[h!]
            \centering
