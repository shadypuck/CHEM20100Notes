        ...
        \begin{enumerate}[label={\textbf{\alph*.}}]
            ...
            \begin{enumerate}[label={(\arabic*)}]
                ...
                \begin{proof}[Answer]
                    ...
                    \end{center}
                    \vspace{1em}
                    The $\sigma$ contributions to the metal orbitals will be identical to the above. However, we now have to account for the $\pi$-acceptor contribution of the equatorial \ce{L}$'$ ligand. Since the rows in the table for positions 2, 11, and 12 vary, we will average the three:
                    \begin{center}
                        \small
                        \renewcommand{\arraystretch}{1.4}
                        \begin{tabular}{c|cccccc}
