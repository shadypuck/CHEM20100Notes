...
\begin{enumerate}[label={\Roman*)}]
    ...
    \begin{enumerate}[label={\textbf{9.\arabic*}}]
        ...
        \begin{enumerate}[label={\textbf{\alph*.}}]
            ...
            \end{center}
            \begin{proof}[Answer]
                There are four stereoisomers of \ce{Fe(dtc)3}. We first divide into $\Lambda$ and $\Delta$ types, and then further subdivide into one with a $C_3$ rotation axis and the other without.
                \begin{enumerate}[label={\arabic*.}]
                    \item $\Lambda$ form, has $C_3$ axis.
                    \begin{center}
                        \begin{tikzpicture}[
                        ...
                        \end{tikzpicture}
                    \end{center}
                    \item $\Lambda$ form, does not have $C_3$ axis.
                    \begin{center}
                        \begin{tikzpicture}[
                            every node/.style={inner sep=1pt,text height=1.5ex,text depth=0.25ex}
                        ]
                    ...
                    \begin{center}
                        ...
                        \end{tikzpicture}
                    \end{center}
                    \item $\Delta$ form, does not have $C_3$ axis.
                    \begin{center}
                        \begin{tikzpicture}[
                            every node/.style={inner sep=1pt,text height=1.5ex,text depth=0.25ex}
                        ]
        ...
        \begin{enumerate}[label={\textbf{\alph*.}}]
            \item \emph{cis}-Diamminebromocchloroplatinum(II).
            \begin{proof}[Answer]
                ${\color{white}hi}$
                \begin{center}
            ...
            \begin{proof}[Answer]
                ${\color{white}hi}$
                \begin{center}
                    \chemfig{Fe(-[:125]OC)(>:[:-155]OC)(<[:-110]OC)(<[:-57,2]\chembelow{C}{O}?[wedge])(>:[:-25]\chembelow{C}{O}?[dash])-[:45,1.5]\chemabove{C}{O}-[:-45,1.5]Fe?[wedge,4]?[dash,7](-[:55]CO)(>:[:-25]CO)(<[:-70]CO)}
                \end{center}
            \end{proof}
        \end{enumerate}
        \newpage
        ...
        \begin{enumerate}[label={\textbf{\alph*.}}]
            ...
            \end{tikzpicture}
            \begin{proof}[Answer]
                This molecule is achiral (if we assume that the ring on the right side largely lies in the plane with quickly reversing buckling or puckering, a reasonable hypothesis given the light \ce{N} and \ce{C} atoms).
            \end{proof}
            \item 
            \begin{tikzpicture}
                \node{
        ...
        \item When \emph{cis}-\ce{OsO2F4} is dissolved in \ce{SbF5}, the cation \ce{OsO2F3+} is formed. The \ce{^{19}F} NMR spectrum of this cation shows two resonances, a doublet and a triplet having relative intensities of $2:1$. What is the most likely structure of this ion? What is its point group?
        \begin{proof}[Answer]
            ...
            \begin{center}
                \chemleft{[}
                    \chemfig{Os(-[6]F)(-F)(-[2]F)(=[:160]O)(=[:-150]O)}
                \chemright{]^+}
            \end{center}
